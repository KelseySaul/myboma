...
export default function PublicLegalPage({type}: PublicLegalPageProps) {
  ...
  return (
    <section className="min-h-screen bg-zinc-50 px-4 pb-16 pt-24 sm:pt-28">
      <div className="mx-auto max-w-3xl">
        <a
          href="/"
          className="inline-flex items-center text-xs font-black uppercase tracking-[0.16em] text-indigo-600 transition-colors hover:text-indigo-800"
        >
          Back to MyBoma
        </a>
        <article className="mt-5 rounded-3xl border border-zinc-200 bg-white p-5 shadow-sm sm:p-9">
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-600">Legal</p>
          <h1 className="mt-2 text-3xl font-black tracking-tight text-zinc-950 sm:text-4xl">{document.title}</h1>
        ...
        <div className="mt-6 flex flex-wrap gap-4 px-2 text-xs font-bold text-zinc-500">
